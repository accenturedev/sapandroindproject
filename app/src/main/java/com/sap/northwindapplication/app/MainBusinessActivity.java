package com.sap.northwindapplication.app;
...
import com.sap.northwindapplication.mdui.ChoiceActivity;
import com.sap.northwindapplication.service.*;
                        ...
                        switch (workInfo.getState()) {
                            ...
                            case FAILED:
                                ...
                                switch (workInfo.getOutputData().getInt(OfflineWorkerUtil.OUTPUT_ERROR_KEY, 0)) {
                                    case -1:
                                        Log.i("error1", "errore1");
                                        offlineNetworkErrorAction();
                                        break;
                                    case -10425:
                                        Log.i("error2", "errore2");
