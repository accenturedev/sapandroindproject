...
import com.sap.northwindapplication.mdui.EntitySetListActivity;
 ...
 * - {@link CategoriesCreateFragment}: to create or edit a(n) Category,
 * - {@link CategoriesDetailFragment}: to display the details of a(n) Category,
 * - {@link CategoriesListFragment}: to list Categories.
 *
 ...
 * what to do.
 */
public class CategoriesActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Category> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CategoriesListFragment} is
     * getting instantiated (which will load {@link CategoriesDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CategoriesListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Category entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CategoriesCreateFragment fragment = new CategoriesCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Category entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CategoriesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CategoriesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Category entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CategoriesCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CategoriesActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CategoryViewModel viewModel = new ViewModelProvider(getActivity()).get(CategoryViewModel.class);
