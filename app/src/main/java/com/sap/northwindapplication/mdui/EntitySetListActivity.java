...
import com.sap.northwindapplication.app.SAPWizardApplication;
...
import kotlin.Unit;
import com.sap.northwindapplication.app.WelcomeActivity;
import com.sap.northwindapplication.mdui.categories.CategoriesActivity;
import com.sap.northwindapplication.mdui.products.ProductsActivity;
import com.sap.northwindapplication.mdui.suppliers.SuppliersActivity;
...
public class EntitySetListActivity extends AppCompatActivity {
    ...
    public enum EntitySetName {
        Categories("Categories", R.string.eset_categories,BLUE_ANDROID_ICON),
    ...
    /* Non serve perchè deve tornare indietro alla schermata principale di selezione bottoni
    @Override
