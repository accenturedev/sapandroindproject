package com.sap.northwindapplication.mdui.products;
...
import com.sap.northwindapplication.databinding.FragmentProductsCreateBinding;
...
public class ProductsCreateFragment extends InterfacedFragment<Product> {
    ...
    private Product createProduct() {
        ...
        productEntity.unsetDataValue(Product.id);
    ...
    private void onComplete(@NonNull OperationResult<Product> result) {
        ...
        if (result.getError() != null) {
            ...
            if( isMasterDetail ) {
                ProductsListFragment listFragment = (ProductsListFragment) currentActivity.getSupportFragmentManager().findFragmentByTag(UIConstants.LIST_FRAGMENT_TAG);
