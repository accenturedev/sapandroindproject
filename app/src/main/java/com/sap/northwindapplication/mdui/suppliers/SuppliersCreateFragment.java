...
import com.sap.northwindapplication.databinding.FragmentSuppliersCreateBinding;
...
public class SuppliersCreateFragment extends InterfacedFragment<Supplier> {
    ...
    private Supplier createSupplier() {
        ...
        supplierEntity.unsetDataValue(Supplier.id);
    ...
    private void onComplete(@NonNull OperationResult<Supplier> result) {
        ...
        if (result.getError() != null) {
            ...
            if( isMasterDetail ) {
                SuppliersListFragment listFragment = (SuppliersListFragment) currentActivity.getSupportFragmentManager().findFragmentByTag(UIConstants.LIST_FRAGMENT_TAG);
