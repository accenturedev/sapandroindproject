package com.sap.applicationnorthwind.service;
...
public class OfflineWorkerUtil {
    ...
    public static DemoService getDemoService() {
        if (demoService == null) {
            throw new NullPointerException("demoService was not initialized.");
        }
        return demoService;
    }
    /*
     ...
     */
    public static final String CONNECTION_ID_DEMOSERVICE = "northwind";
    ...
    public static void initializeOffline(
        ...
        try {
            URL url = new URL(serviceUrl + CONNECTION_ID_DEMOSERVICE);
            ...
            OfflineODataDefiningQuery categoriesQuery = new OfflineODataDefiningQuery("Categories", "Categories", false);
            offlineODataProvider.addDefiningQuery(categoriesQuery);
            OfflineODataDefiningQuery productsQuery = new OfflineODataDefiningQuery("Products", "Products", false);
            offlineODataProvider.addDefiningQuery(productsQuery);
            OfflineODataDefiningQuery suppliersQuery = new OfflineODataDefiningQuery("Suppliers", "Suppliers", false);
            offlineODataProvider.addDefiningQuery(suppliersQuery);
            demoService = new DemoService(offlineODataProvider);
        } catch (Exception e) {
